...
```{r message=FALSE, warning=FALSE, fig.width=10, fig.height=5}
print(xtable(species %>% select(phylum, class, species, category, new), type = "latex"), file = "report/species.tex", include.rownames = FALSE, tabular.environment = "longtable", floating = FALSE, size="\\fontsize{9pt}{10pt}\\selectfont")
```
