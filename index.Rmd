...
print(xtable(species %>% select(phylum, class, species, group, category, new, vernacular), type = "latex"), file = "report/species.tex", include.rownames = FALSE, tabular.environment = "longtable", floating = FALSE, size = "\\fontsize{9pt}{10pt}\\selectfont", add.to.row = addtorow, hline.after = c(-1))
```
...
print(xtable(group_stats, type = "latex"), file = "report/group_stats.tex", include.rownames = FALSE, tabular.environment = "longtable", floating = FALSE)
```
...
print(xtable(category_stats, type = "latex"), file = "report/category_stats.tex", include.rownames = FALSE, tabular.environment = "longtable", floating = FALSE)
```
...
cols <- hcl.colors(length(unique(species_grouped$group)), "Zissou 1")
