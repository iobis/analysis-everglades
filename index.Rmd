...
svg_text <- paste(readLines("map/dna.svg"), collapse = "\n")
...
ggplot() +
  ...
  # geom_point_svg(data = sites, aes(decimalLongitude, decimalLatitude), svg = svg_text, fill = "#a83236") +
...
ggsave("report/tree.png", scale = 1.2)
```
