...
print(xtable(species %>% select(phylum, class, species, category, new, vernacular), type = "latex"), file = "report/species.tex", include.rownames = FALSE, tabular.environment = "longtable", floating = FALSE, size = "\\fontsize{9pt}{10pt}\\selectfont", add.to.row = addtorow, hline.after = c(-1))
```
